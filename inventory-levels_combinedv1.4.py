# Add Darwin to accompany 4.2 & BR
...
df_darwin_items['NewCount'].fillna(0, inplace=True)  # Handle NaN for Darwin_Items
...
try:
    ...
    plt.title(f'Combined: B4.2, Level 6 Build Room & Darwin - {current_date}', fontsize=14)
    plt.legend()
    plt.tight_layout()
